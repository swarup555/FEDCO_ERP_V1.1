...
namespace DATA_LAYER.HRMSGR
{
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        public virtual void BatchInsert(List<TEntity> entity)
        {
        ...
        public virtual IEnumerable<TBL_EMP_BASICINFO> Retrieve()
        {
            // you can nest as many as you want if there are more nav properties
            var _query = Context.TBL_EMP_BASICINFO
                .Include(a => a.TBL_HRMS_DESIGNATIONMASTER)
                .Include(a => a.TBL_HRMS_DEPARTMENTMASTER)
                .Include(a => a.TBL_EMP_COMMUNICATION_DETAILS);
            return _query.ToList();
        }
        public virtual IEnumerable<TBL_EMP_BASICINFO> RetrieveEmp() 
        {
            // you can nest as many as you want if there are more nav properties
            var _query = Context.TBL_EMP_BASICINFO
                .Include(a => a.TBL_EMP_QUALIFICATION_DETAILS)
                .Include(a => a.TBL_EMP_RELATIONSHIP_DETAILS)
                .Include(a => a.TBL_EMP_TRANSFER_DETAILS)
                .Include(a => a.TBL_EMP_EMPLOYMENT_RECORD)
                .Include(a => a.TBL_EMP_COMMUNICATION_DETAILS);
            return _query.ToList();
        }
        /// <summary>
