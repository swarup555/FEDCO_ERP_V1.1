...
namespace FEDCO_ERP_V1._1.Controllers
{
    public class AssettypeController : Controller
    {
        ...
        public async Task<ActionResult> AssettypeCreate(AssetTypeEntities dept)
        {
        ...
        public async Task<ActionResult> AssettypeEdit(AssetTypeEntities dept, FormCollection fc)
        {
        ...
        public async Task<ActionResult> AssettypeDelete(FormCollection fc)
        {
