function ExportJQGridDataToExcel(tableCtrl, excelFilename) {
    ...
    postAndRedirect("/Handler/ExportGridToExcel.ashx?filename=" + excelFilename, { excelData: excelData });
}

function removeLastChar(str) {
    //  Remove the last character from a stringl
